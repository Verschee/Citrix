...
`n[INFO]`tPath for exported list of servers and compliance status (Summary): $summary`n[INFO]`tPath for exported list of servers not in compliance (Non-Compliant): $noncompTXT `n`n[INFO]`t Starting Operation..."
